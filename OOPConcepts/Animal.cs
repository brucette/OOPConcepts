...
namespace OOPConcepts
{
    internal abstract class Animal
    {
        ...
        {
            return $"Properties for a {GetType().Name}" +
                $"\nName: {Name}" +
                $"\nWeight: {Weight}" +
                $"\nAge: {Age}\n";
        }
    ...
    internal class Horse : Animal
    {
        ...
        public override string Stats()
        {
            ...
            return baseProperties + $"Height: {Height}\n";
        }
    }
    ...
    internal class Dog: Animal 
    {
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"Breed: {Breed}\n";
        }

        public string CatchBall()
        {
            return "Ball thrown! *bounce bounce run run*\n";
        }
    }
    ...
    { 
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"NrOfSpikes: {NrOfSpikes}\n";
        }
    }
    ...
    internal class Worm : Animal 
    {
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"IsPoisonous: {IsPoisonous}\n";
        }
    }
    ...
    { 
        ...
        {
            string baseproperties = base.Stats();
            return baseproperties + $"WingSpan: {WingSpan}\n";
        }
    }
    ...
    internal class Wolf : Animal 
    {
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"Color: {Color}\n";
        }
    }
    ...
    internal class Pelican: Bird 
    {
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"BeakLength: {BeakLength}\n";
        }
    }
    ...
    internal class Flamingo : Bird 
    {
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"LegLength: {LegLength}\n";
        }
    }
    ...
    internal class Swan : Bird 
    {
        ...
        {
            string baseProperties = base.Stats();
            return baseProperties + $"NeckLength: {NeckLength}\n";
        }
    }
